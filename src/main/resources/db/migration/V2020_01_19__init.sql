CREATE SEQUENCE public.hotelo_customer_id_seq
    INCREMENT BY 1
    START WITH 1;
create table if not exists hotelo_customer
(
    id                    bigint DEFAULT NEXTVAL('public.hotelo_customer_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_hotel_id_seq
    INCREMENT BY 1
    START WITH 1;
create table if not exists hotelo_hotel
(
    id        bigint DEFAULT NEXTVAL('public.hotelo_hotel_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_location_id_seq
    INCREMENT BY 1
    START WITH 1;
create table if not exists hotelo_location
(
    id          bigint DEFAULT NEXTVAL('public.hotelo_location_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_cart_id_seq
    INCREMENT BY 1
    START WITH 1;
create table if not exists hotelo_cart
(
    id          bigint DEFAULT NEXTVAL('public.hotelo_cart_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_section_id_seq
    INCREMENT BY 1
    START WITH 1;

create table if not exists hotelo_section
(
    id          bigint DEFAULT NEXTVAL('public.hotelo_section_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_room_id_seq
    INCREMENT BY 1
    START WITH 1;

create table if not exists hotelo_room
(
    id         bigint DEFAULT NEXTVAL('public.hotelo_room_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_cart_item_id_seq
    INCREMENT BY 1
    START WITH 1;

create table if not exists hotelo_cart_item
(
    id         bigint DEFAULT NEXTVAL('public.hotelo_cart_item_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_order_id_seq
    INCREMENT BY 1
    START WITH 1;
create table if not exists hotelo_order
(
    id           bigint DEFAULT NEXTVAL('hotelo_order_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_order_detail_id_seq
    INCREMENT BY 1
    START WITH 1;
create table if not exists hotelo_order_detail
(
    id           bigint DEFAULT NEXTVAL('hotelo_order_detail_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_price_id_seq
    INCREMENT BY 1
    START WITH 1;

create table if not exists hotelo_price
(
    id          bigint DEFAULT NEXTVAL('hotelo_price_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_role_id_seq
    INCREMENT BY 1
    START WITH 1;
create table if not exists hotelo_role
(
    id          bigint                DEFAULT NEXTVAL('hotelo_role_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_token_id_seq
    INCREMENT BY 1
    START WITH 1;
create table if not exists hotelo_token
(
    id           bigint DEFAULT NEXTVAL('hotelo_token_id_seq'::regclass) NOT NULL
...
CREATE SEQUENCE public.hotelo_user_id_seq
    INCREMENT BY 1
    START WITH 1;
CREATE TABLE IF NOT EXISTS hotelo_user
(
    id            bigint DEFAULT NEXTVAL('public.hotelo_user_id_seq'::regclass) NOT NULL,
    is_active     boolean                                                       NOT NULL,
